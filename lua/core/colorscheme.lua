...
function Default_Dark()
	...
	vim.o.bg = "dark"
	vim.api.nvim_set_hl(0, "TabLineFill", { bg = colors.mediumgray })
	vim.api.nvim_set_hl(0, "TabLine", { bg = colors.mediumgray })
	...
	modify_hl(0, "SignColumn", { bg = colors.mediumgray })
	...
	if dark_theme == "vim" then
		...
		vim.api.nvim_set_hl(0, "Pmenu", { fg = "white", bg = colors.mediumgray })
		vim.api.nvim_set_hl(0, "PmenuSel", { bold = 1, bg = "gray", fg = "black" })
